...
<div class="slider-wrapper theme-default">
	<div id="slider" class="nivoSlider">
		...
		<a href="http://geeksband.com"><img src="assets/images/slide2.jpg" alt="" title="This is an example of a caption with a link" /></a>
		<img src="assets/images/slide3.jpg" alt="" title="This is an example of a caption" />
...
<section>
	...
	<div id="derniers-articles">
		<article id="art-1">
			...
			<a href="?p=article" class="rm">En savoir plus...</a>
		</article>
		<article id="art-2">
			<h1>Article 2</h1>
